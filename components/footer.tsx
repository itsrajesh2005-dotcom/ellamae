          ...
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 transition-colors hover:bg-gold hover:border-gold hover:text-white text-white/80"
              >
              ...
              <a
                href="https://www.youtube.com/@ellamae-az"
                target="_blank"
                rel="noopener noreferrer"
                data-cursor="pointer"
