...
export function BrandsList() {
  ...
  // Filter Logic Fix:
  // 1. "all" select பண்ணியிருந்தா எல்லா brands-உம் காட்டும்.
  // 2. குறிப்பிட்ட category select பண்ணியிருந்தா:
  //    - அந்த category ID-க்குரிய brand காட்டும்.
  //    - "All Categories" (category_id null / empty / undefined) வைத்து உருவாக்கப்பட்ட brand-உம் கட்டாயம் காட்டும்.
