...
try {
    ...
    /*---------DATABASE CONNECTION---------*/
    $conn = new mysqli("192.168.1.79", "root", "", "ellamae_db");
    ...
    // 1. Create the main gifts table with brand_id & category_id
    ...
    // Auto-add brand_id column if not exists
    @$conn->query("ALTER TABLE gifts ADD COLUMN brand_id INT NULL AFTER id");
